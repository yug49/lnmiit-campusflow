...
const MONGO_ATLAS_URI =
  "mongodb+srv://agarwalyug1976:yugLNMIITCampusConnect@lnmiit-campusconnect.246sest.mongodb.net/lnmiit-campusflow?retryWrites=true&w=majority&appName=LNMIIT-CampusConnect";
...
console.log(
  "dotenv path:",
  require("dotenv").config().path || "No .env file loaded"
);
...
const getMongoURITest = () => {
  if (process.env.NODE_ENV === "production") {
    ...
    console.log(
      `Non-production environment detected in function: "${process.env.NODE_ENV}"`
    );
    return (
