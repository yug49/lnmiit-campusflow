...
const AdminDashboard = () => {
    ...
    const { userProfilePhoto, userName, logout } = useUser();
    ...
    const mainFeatures = [
        {
            ...
            subtitle: "Add, edit, or remove users and manage their roles",
            icon: "👤",
            path: "/admin/users",
        },
        {
        ...
        },
        {
            title: "MoU Approval",
            subtitle:
                "Review and approve MoUs submitted by council representatives",
            icon: "📄",
            path: "/admin/mou",
        },
        {
        ...
        },
        {
            ...
            subtitle:
                "Manage candidature and voter approvals for council elections",
            icon: "🗳️",
