...
const FacultyInvoiceApproval = () => {
    ...
    const handleApprove = async () => {
        ...
        try {
            ...
            if (response.success) {
                ...
                setError("");
                setCopySuccess("Invoice signed successfully!");
                setTimeout(() => setCopySuccess(""), 3000);
            }
        } catch (err) {
    ...
    const handleReject = async () => {
        ...
        try {
            ...
            const response = await api.invoice.rejectPermission(
                selectedEvent._id,
                rejectionReason
            );
            ...
            if (response.success) {
                ...
                setRejectionReason("");
                await fetchInvoices(); // Refresh the list
                setCopySuccess("Invoice rejected successfully");
                setTimeout(() => setCopySuccess(""), 3000);
            }
        } catch (err) {
            ...
            return (
                <Box sx={{ p: 4, textAlign: "center" }}>
                    <Typography variant="body1" color="text.secondary">
                        No pending Invoices require your approval at this time.
                    </Typography>
                </Box>
            );
        }
